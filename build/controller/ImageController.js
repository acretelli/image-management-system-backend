...
var ImageBusiness_1 = require("../business/ImageBusiness");
var BaseDatabase_1 = require("../data/BaseDatabase");
var ImageDatabase_1 = require("../data/ImageDatabase");
var Authenticator_1 = require("../services/Authenticator");
var IdGenerator_1 = require("../services/IdGenerator");
var ImageController = (function () {
    function ImageController() {
        var _this = this;
        this.searchImage = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var searchData, result, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, ImageController.imageBusiness.searchImage(searchData)];
                    case 1:
                        result = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, ImageController.imageBusiness.createImage(token, input)];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, ImageController.imageBusiness.getImageById(token, id)];
                    case 1:
                        image = _a.sent();
    ...
    ImageController.prototype.getAllImages = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var token, image, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        token = req.headers.authorization;
                        return [4, ImageController.imageBusiness.getAllImages(token)];
                    case 1:
                        image = _a.sent();
                        res.status(200).send({ image: image });
                        return [3, 3];
    ...
    ImageController.prototype.addImageToCollection = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var token, imageId, collectionId, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        return [4, ImageController.imageBusiness.addImageInCollection(token, imageId, collectionId)];
                    case 1:
                        _a.sent();
